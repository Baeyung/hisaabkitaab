export const en = {
  ...
  'stores.first.title': 'Set up your first shop',
  'stores.first.help':
    "Your shop's name appears on every bill, khata, and report. Add it to get started.",
  'stores.new.title': 'Add a shop',
  'stores.new.help': 'Each shop keeps its own cashbook, khatas, and stock — nothing is shared between them.',
  'stores.new.note': 'Logo, watermark, and the opening drawer balance can be set afterwards in Settings › General.',
