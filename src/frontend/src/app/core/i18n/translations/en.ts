export const en = {
  ...
  'auth.verifyPending.sentTo': 'We sent a link to',
  'auth.verifyPending.body':
    'Open the email and tap the verify button. Once verified, come back and log in.',
  'auth.verifyPending.resend': 'Resend email',
  ...
  'auth.verifyEmail.verifying.title': 'Verifying…',
  'auth.verifyEmail.verifying.body': 'Just a moment while we confirm your account.',
  'auth.verifyEmail.success.title': 'Verification successful',
  'auth.verifyEmail.success.body': 'Your account is verified. Head back to the app and log in.',
  'auth.verifyEmail.error.title': 'Link not valid',
  'auth.verifyEmail.error.body':
    'This link is invalid or was already used. Try logging in, or resend the email.',
  'auth.verifyEmail.toLogin': 'Go to log in',
