export const en = {
  ...
  'settings.menu.board.help':
    'Every row here is a button on the board. Drag one anywhere — into a band, out of it, onto another tab. Rename anything to what you call it, and hide what you never open. Everyone working in this shop sees the board you set here.',
  'settings.menu.board.grouping':
    'A row lands inside whatever heading it is dropped under. Below a heading, "inside it" and "after it" look the same in a list, so the two step buttons on a row are how you say which you meant. A group at the top level is a tab; a group inside one is a band, and a band carries a colour that says which way money moves through it.',
  ...
  'settings.menu.items.help':
    'Every row here is a row of the menu. Drag one anywhere — into a group, out of it, up to the top. Rename anything to what you call it, and hide what you never open. Everyone working in this shop sees the menu you set here.',
  'settings.menu.items.grouping':
    'A row lands inside whatever heading it is dropped under. Below a heading, "inside it" and "after it" look the same in a list, so the two step buttons on a row are how you say which you meant. Make your own groups for the screens you use together — Sale and Sales on one, say.',
  'settings.menu.addGroup': 'New group',
  'settings.menu.newGroup': 'New group',
  'settings.menu.groupName': 'Name this group',
  'settings.menu.groupEmpty': 'Nothing in here yet. Drag a row down onto this space.',
  'settings.menu.grip': 'Move {{item}}. Drag it, or use the arrow keys.',
  'settings.menu.indent': 'Put {{item}} inside the group above it',
  'settings.menu.outdent': 'Take {{item}} out of its group',
  'settings.menu.hideItem': 'Hide {{item}} from the menu',
  'settings.menu.showItem': 'Show {{item}} in the menu',
  'settings.menu.atTop': 'the top level',
  'settings.menu.at': '{{item}} is now {{n}} of {{m}} in {{where}}',
  ...
  'sale.party.cash.ph': 'Customer name for the bill (optional)…',
  ...
  'purchase.party.cash.ph': 'Supplier name for the bill (optional)…',
  ...
  'ledger.print.address': 'Address: {{query}}',
  'ledger.print.direction': 'Showing: {{filter}}',
  'ledger.sections.title': 'What should this include?',
  'ledger.sections.body': 'Choose which sections to print or send.',
  'ledger.sections.continue': 'Continue',
  ...
  'ledger.search.ph': 'Search by name or contact…',
  'ledger.search.none': 'No parties match your search.',
  'ledger.filter.search': 'Search',
  'ledger.filter.address': 'Address',
  'ledger.address.ph': 'Search by address…',
  'ledger.filter.direction': 'Filter',
  ...
  'ledger.category.search.ph': 'Search categories…',
  'ledger.category.none': 'No expenses in this range.',
  'ledger.cash.title': 'Cash',
  'ledger.cash.col.type': 'Type',
  'ledger.cash.col.total': 'Total',
  'ledger.cash.kind.SALE': 'Sales',
  'ledger.cash.kind.PURCHASE': 'Purchases',
  'ledger.cash.detail.notFound': 'This was not found.',
  'ledger.cash.search.label': 'Search',
  'ledger.cash.search.ph': 'Search bills…',
  'ledger.cash.search.none': 'No bills match your search.',
  'ledger.cash.detail.empty': 'No entries in this range.',
  'ledger.cash.kind.ph': 'Search…',
  'ledger.cash.none': 'No cash entries in this range.',
  ...
  // ── Profit analysis ──
  // Costs are not recorded when a bill is made, so every figure on this screen is
  // reconstructed from the goods ledger. The wording says so plainly rather than
  // hedging: a shopkeeper acting on a number deserves to know how it was arrived at.
  'profit.subtitle': 'What the shop kept, not just what it took.',
  'profit.loadError': 'Couldn’t load the profit report. Please try again.',
  'profit.empty.title': 'Nothing sold in these dates',
  'profit.empty.body': 'Record a sale, or pick a wider date range.',
  'profit.note':
    'These figures are worked out from your purchases and sales, not recorded at the till. They are only as good as the rates entered on your bills.',
  'profit.coverage.label': 'Costed sales',
  'profit.coverage.value': '{{pct}}% of sales had a known cost',
  'profit.coverage.allCosted': 'nothing was left out of the figures.',
  'profit.coverage.missing': '{{count}} sold without one, listed below.',
  'profit.revenue': 'Revenue',
  'profit.revenue.hint': 'Sold in these dates, after discounts',
  'profit.discounts.hint': '{{amount}} knocked off bills',
  'profit.cogs': 'Cost of goods',
  'profit.cogs.hint': 'What those goods cost you',
  'profit.gross': 'Gross profit',
  'profit.gross.hint': 'Before running costs',
  'profit.expenses': 'Expenses',
  'profit.expenses.hint': 'Rent, bijli, and the rest',
  'profit.net': 'Net profit',
  'profit.net.hint': 'Kept after everything',
  'profit.answer.of': '{{pct}}% of the {{revenue}} you sold',
  'profit.margin': '{{pct}}% margin',
  'profit.unmeasured': 'No costs known yet',
  'profit.unmeasured.hint': 'Set cost prices to see this',
  'profit.trend.title': 'Day by day',
  'profit.trend.hint': 'Gross profit — expenses land on the day they were paid',
  'profit.trend.aria':
    'Daily gross profit over the window. Total {{profit}} on {{revenue}} of sales.',
  'profit.chart.profit': 'Profit',
  'profit.chart.margin': 'Margin %',
  'profit.best.title': 'Best day',
  'profit.worst.title': 'Worst day',
  'profit.day.on': 'on {{revenue}} of sales',
  'profit.topItems.title': 'What paid for the shop',
  'profit.topItems.empty': 'Nothing costed sold in these dates.',
  'profit.byProfit': 'By profit',
  'profit.loss.title': 'Sold below cost',
  'profit.loss.sub': 'Check the rate on these',
  'profit.loss.empty': 'Nothing went out below cost.',
  'profit.uncosted.title': 'Sales we couldn’t price',
  'profit.uncosted.sub': 'Left out of the figures above',
  'profit.uncosted.fix.cost': 'Set its cost price',
  'profit.uncosted.fix.purchase': 'Record the purchase',
  'profit.uncosted.link': 'Open the item list',
  'profit.print.date': 'Date',
  'profit.print.revenue': 'Sales',
  'profit.print.cogs': 'Cost',
  'profit.print.profit': 'Profit',
  'profit.print.margin': 'Margin',
  'profit.stmt.title': 'The working',
  'profit.stmt.hint': 'What sold, at what rate, at what cost',
  'profit.stmt.item': 'Design',
  'profit.stmt.qty': 'Sold',
  'profit.stmt.saleRate': 'Sale rate',
  'profit.stmt.costRate': 'Cost rate',
  'profit.stmt.unpriced': '{{qty}} ({{amount}}) sold with no cost known — left out of its profit',
  'profit.stmt.uncategorised': 'Uncategorised',
  'profit.stmt.gapNote':
    'Rates and profit are averages over the costed sales. {{amount}} of sales had no cost behind them and count in revenue only — record their purchases and this page will pick them up.',
