...
export const ur: Record<TranslationKey, string> = {
  ...
  'nav.settings.reports': 'خودکار رپورٹس',
  ...
  'settings.menu.board.help':
    'یہاں کی ہر سطر بورڈ کا ایک بٹن ہے۔ کسی بھی سطر کو کہیں بھی گھسیٹ لے جائیں — کسی پٹی کے اندر، اُس سے باہر، یا کسی اور ٹیب پر۔ نام اپنی مرضی کا رکھیں، اور جو کبھی نہیں کھولتے اُسے چھپا دیں۔ اس دکان میں کام کرنے والے سب کو وہی بورڈ نظر آئے گا جو آپ یہاں سیٹ کریں گے۔',
  'settings.menu.board.grouping':
    'سطر جس عنوان کے نیچے چھوڑی جائے، اُسی کے اندر چلی جاتی ہے۔ فہرست میں «اندر» اور «بعد» ایک ہی جگہ لگتے ہیں، اس لیے سطر پر موجود دو بٹن یہ بتاتے ہیں کہ آپ کا مطلب کیا تھا۔ سب سے اوپر والا گروپ ایک ٹیب ہے، اور اُس کے اندر والا گروپ ایک پٹی — اور ہر پٹی کا رنگ بتاتا ہے کہ رقم کس طرف جا رہی ہے۔',
  ...
  'settings.menu.items.help':
    'یہاں کی ہر سطر مینو کی ایک سطر ہے۔ کسی بھی سطر کو کہیں بھی گھسیٹ لے جائیں — کسی گروپ کے اندر، اُس سے باہر، یا سب سے اوپر۔ نام اپنی مرضی کا رکھیں، اور جو کبھی نہیں کھولتے اُسے چھپا دیں۔ اس دکان میں کام کرنے والے سب کو وہی مینو نظر آئے گا جو آپ یہاں سیٹ کریں گے۔',
  'settings.menu.items.grouping':
    'سطر جس عنوان کے نیچے چھوڑی جائے، اُسی کے اندر چلی جاتی ہے۔ فہرست میں «اندر» اور «بعد» ایک ہی جگہ لگتے ہیں، اس لیے سطر پر موجود دو بٹن یہ بتاتے ہیں کہ آپ کا مطلب کیا تھا۔ جو اسکرینیں آپ ساتھ استعمال کرتے ہیں اُن کا اپنا گروپ بنا لیں — مثلاً فروخت اور بل ایک ہی گروپ میں۔',
  'settings.menu.addGroup': 'نیا گروپ',
  'settings.menu.newGroup': 'نیا گروپ',
  'settings.menu.groupName': 'اس گروپ کا نام رکھیں',
  'settings.menu.groupEmpty': 'ابھی یہاں کچھ نہیں۔ کوئی سطر گھسیٹ کر اس جگہ پر لے آئیں۔',
  'settings.menu.grip': '{{item}} کو منتقل کریں۔ گھسیٹیں، یا تیر والے بٹن دبائیں۔',
  'settings.menu.indent': '{{item}} کو اوپر والے گروپ کے اندر کریں',
  'settings.menu.outdent': '{{item}} کو اس کے گروپ سے باہر نکالیں',
  'settings.menu.hideItem': '{{item}} کو مینو سے چھپا دیں',
  'settings.menu.showItem': '{{item}} کو مینو میں دکھائیں',
  'settings.menu.atTop': 'سب سے اوپر کی سطح',
  'settings.menu.at': '{{item}} اب {{where}} میں {{m}} میں سے {{n}} نمبر پر ہے',
  ...
  'sale.party.cash.ph': 'بل کے لیے کسٹمر کا نام (اختیاری)…',
  ...
  'purchase.party.cash.ph': 'بل کے لیے سپلائر کا نام (اختیاری)…',
  ...
  'whatsapp.doc.profit': 'نفع کی رپورٹ',
  ...
  'ledger.print.address': 'پتہ: {{query}}',
  ...
  // ── Profit analysis ──
  'profit.subtitle': 'دکان نے کیا بچایا، صرف کیا کمایا نہیں۔',
  'profit.loadError': 'نفع کی رپورٹ لوڈ نہیں ہو سکی۔ دوبارہ کوشش کریں۔',
  'profit.empty.title': 'ان تاریخوں میں کچھ فروخت نہیں ہوا',
  'profit.empty.body': 'کوئی سیل درج کریں، یا تاریخوں کا دورانیہ بڑھائیں۔',
  'profit.note':
    'یہ اعداد آپ کی خریداری اور فروخت سے نکالے گئے ہیں، کاؤنٹر پر درج نہیں ہوتے۔ یہ اتنے ہی درست ہیں جتنے آپ کے بلوں پر لکھے ریٹ۔',
  'profit.coverage.label': 'لاگت والی سیل',
  'profit.coverage.value': '{{pct}}% سیل کی لاگت معلوم تھی',
  'profit.coverage.allCosted': 'کوئی سیل حساب سے باہر نہیں رہی۔',
  'profit.coverage.missing': '{{count}} کی لاگت معلوم نہیں، نیچے دیکھیں۔',
  'profit.revenue': 'سیل',
  'profit.revenue.hint': 'ان تاریخوں میں فروخت، رعایت کے بعد',
  'profit.discounts.hint': '{{amount}} بلوں سے کم کیے گئے',
  'profit.cogs': 'مال کی لاگت',
  'profit.cogs.hint': 'وہ مال آپ کو کتنے کا پڑا',
  'profit.gross': 'مجموعی نفع',
  'profit.gross.hint': 'دکان کے خرچ سے پہلے',
  'profit.expenses': 'اخراجات',
  'profit.expenses.hint': 'کرایہ، بجلی اور باقی خرچ',
  'profit.net': 'خالص نفع',
  'profit.answer.of': 'جو {{revenue}} کی سیل ہوئی، اُس کا {{pct}}%',
  'profit.net.hint': 'سب کچھ نکال کر بچا',
  'profit.margin': '{{pct}}% مارجن',
  'profit.unmeasured': 'ابھی کوئی لاگت معلوم نہیں',
  'profit.unmeasured.hint': 'دیکھنے کے لیے لاگت قیمت درج کریں',
  'profit.trend.title': 'روز بروز',
  'profit.trend.hint': 'مجموعی نفع — خرچ اسی دن آتا ہے جس دن ادا ہوا',
  'profit.trend.aria': 'دورانیے کا روزانہ مجموعی نفع۔ {{revenue}} کی سیل پر کل {{profit}}۔',
  'profit.chart.profit': 'نفع',
  'profit.chart.margin': 'مارجن %',
  'profit.best.title': 'بہترین دن',
  'profit.worst.title': 'سب سے کمزور دن',
  'profit.day.on': '{{revenue}} کی سیل پر',
  'profit.topItems.title': 'دکان کس نے چلائی',
  'profit.topItems.empty': 'ان تاریخوں میں لاگت والا کچھ نہیں بکا۔',
  'profit.byProfit': 'نفع کے حساب سے',
  'profit.loss.title': 'لاگت سے کم پر بکا',
  'profit.loss.sub': 'ان کا ریٹ دیکھ لیں',
  'profit.loss.empty': 'کچھ بھی لاگت سے کم پر نہیں گیا۔',
  'profit.uncosted.title': 'جن کی لاگت نہیں نکل سکی',
  'profit.uncosted.sub': 'اوپر کے حساب سے باہر',
  'profit.uncosted.fix.cost': 'اس کی لاگت قیمت درج کریں',
  'profit.uncosted.fix.purchase': 'خریداری درج کریں',
  'profit.uncosted.link': 'مال کی فہرست کھولیں',
  'profit.print.date': 'تاریخ',
  'profit.print.revenue': 'سیل',
  'profit.print.cogs': 'لاگت',
  'profit.print.profit': 'نفع',
  'profit.print.margin': 'مارجن',
  'profit.stmt.title': 'پورا حساب',
  'profit.stmt.hint': 'کیا بکا، کس ریٹ پر، کتنے کا پڑا تھا',
  'profit.stmt.item': 'ڈیزائن',
  'profit.stmt.qty': 'بکا',
  'profit.stmt.saleRate': 'سیل ریٹ',
  'profit.stmt.costRate': 'لاگت ریٹ',
  'profit.stmt.unpriced': '{{qty}} ({{amount}}) بغیر معلوم لاگت کے بکا — اس کے نفع میں شامل نہیں',
  'profit.stmt.uncategorised': 'بغیر مد کے',
  'profit.stmt.gapNote':
    'ریٹ اور نفع لاگت والی سیل کی اوسط ہیں۔ {{amount}} کی سیل کے پیچھے کوئی لاگت نہیں تھی، وہ صرف آمدن میں گنی گئی ہے — ان کی خریداری درج کریں تو یہ صفحہ انہیں شامل کر لے گا۔',
  ...
  'ledger.search.ph': 'نام یا رابطہ تلاش کریں…',
  'ledger.search.none': 'تلاش سے کوئی پارٹی نہیں ملی۔',
  'ledger.filter.search': 'تلاش',
  'ledger.filter.address': 'پتہ',
  'ledger.address.ph': 'پتہ تلاش کریں…',
  ...
  'ledger.category.search.ph': 'کیٹیگری تلاش کریں…',
  'ledger.category.none': 'اس عرصے میں کوئی خرچہ نہیں۔',
  ...
  'ledger.cash.kind.ph': 'تلاش کریں…',
  'ledger.cash.none': 'اس عرصے میں نقد کا کوئی اندراج نہیں۔',
