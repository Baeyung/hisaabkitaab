...
export const ur: Record<TranslationKey, string> = {
  ...
  'settings.menu.items.help':
    'ترتیب بدلنے کے لیے گھسیٹیں، یا تیر کے نشان استعمال کریں۔ جس چیز کو آپ جس نام سے پکارتے ہیں وہی نام رکھ دیں، اور جو کبھی نہیں کھولتے اسے بند کر دیں۔ اس دکان میں کام کرنے والے سب کو وہی مینو نظر آئے گا جو آپ یہاں بنائیں گے۔',
