...
REM
REM Usage:
REM   load-dummy-data.bat                            seeds test@test.com / test
REM   load-dummy-data.bat you@example.com secret     seeds that account instead
...
set WSLENV=EMAIL/u:PASSWORD/u:BASE_URL/u:CONTACT_NUMBER/u
